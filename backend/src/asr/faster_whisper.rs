...
use super::{AsrEngine, AsrInput, AsrRequest, Transcript, TranscriptSegment};
use crate::{
    common::{LanguageTag, TimeRange},
    error::{AsrError, CoreError},
};

/// ASR adapter for faster-whisper. PyAV performs media decoding, resampling and mono conversion.
